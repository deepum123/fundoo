...
class BitlyClient {
    ...
    shorten(longUrl) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.bitlyRequest("shorten", { longUrl });
        });
    }
    /**
    ...
    expand(items) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.bitlyRequest("expand", lib_1.sortUrlsAndHash(items));
        });
    }
    /**
    ...
    bitlyRequest(method, data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const result = yield lib_1.doRequest(this.accessToken, method, data, this.config);
